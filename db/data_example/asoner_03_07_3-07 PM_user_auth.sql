...
# Database: asoner
# Generation Time: 2015-07-03 08:07:54 +0000
# ************************************************************
...
VALUES
	...
	('company-admin',1,'This is company admin who will has all permission in his company.',NULL,NULL,1435547323,1435908919),
	('company-user',1,'it\'s assigned to user who belongs the specified company',NULL,NULL,1435547442,1435908951),
...
LOCK TABLES `company_users_info` WRITE;
/*!40000 ALTER TABLE `company_users_info` DISABLE KEYS */;

INSERT INTO `company_users_info` (`id`, `account_type`, `cost`, `contract_type`, `term_start`, `term_end`, `status`, `users_id`, `created_at`, `updated_at`)
VALUES
	(1,'1','3000',1,NULL,NULL,NULL,7,'2015-07-03 14:13:58','2015-07-03 14:31:49');

/*!40000 ALTER TABLE `company_users_info` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	...
	(4,'companyuser','Company','User','companyuser@asoner.com','$2y$13$JXu4g5E4MwR8jvNK41wp7..zMtI2.MF4g8i/euiHv1qtGTdVe0fl6','8IrxXwJp4sHBFeWW-gebp1f75T_nLCRx',NULL,'ZZMYiUW5FaDzY4eDo1p8f5p2eg8_yK-K',1,0,2,'2015-07-01 16:06:12','2015-07-02 14:56:52'),
	(5,'companyadmin','Company','Admin','companyadmin@asoner.com','$2y$13$djseGQlCMk1rHXoRs3gnPubMQ6N9Tl0iZMf3uMXyGyoRKlLtDg2gy','ifh78o0xLJ8zfNapw_HURpVoTqnSmL5u',NULL,'zZFa5FaHsoMVrUYyb_DqZ1QevRdObzFR',1,0,1,'2015-07-01 16:07:58','2015-07-02 11:07:08'),
	(6,'aa','aaa','aaa','aaa@mgico.com11','$2y$13$9SBsqZVF/6BCxAgssv8Bpu2uuOltp6PFIoF074Zonvbnhzb7/pzom','B8viCcMySxr-KCwGQgI9OrHe5XtnvzSa',NULL,'Mnb9YqWlwpQu91YXV_zXzw-H5AC_Rxbf',1,0,NULL,'2015-07-03 10:06:52','2015-07-03 10:06:52'),
	(7,'aaa','','','aaa@mgico.com','$2y$13$Iqp6uqthv3MXwfZMbKYcLuvz46llgbvm41nq430GhGAokXCR3G5hy','Ag3bZ0w5XVdoC8Lq9TOvFIGyTkwzme0G',NULL,'17ldhwMVs_44RmwzDsjTaSDB9VirVKos',0,5,2,'2015-07-03 14:13:58','2015-07-03 14:31:49');
